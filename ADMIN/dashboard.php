...
require('inc/header.php');
   ...
   $unread_reviews=mysqli_fetch_assoc(mysqli_query($con,"SELECT COUNT(sr_no) AS `count` FROM `ratting_review` WHERE `seen`=0"));
    ...
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden " >
          ...
          <div class="row mb-4">
            ...
            <div class="col-md-3 mb-4">
              <a href="user_querise.php" class="text-decoration-none">
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-3 mb-4">
                <div class="card text-center text-primary p-3">
                  <h6>Querise</h6>
                  <h1 class="mt-2 mb-0" id="total_queriess">0</h1>
                </div>
            </div>
            <div class="col-md-3 mb-4">
                <div class="card text-center text-primary p-3">
