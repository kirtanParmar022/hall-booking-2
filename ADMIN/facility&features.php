...
<head>
    ...
    <title>Admin Panel - facility & features</title>
    <?php
 ...
 <div class="container-fluid" id="main-content">
    <div class="row">
        <div class="col-lg-10 ms-auto p-4 overflow-hidden" >
           <h4 class="mb-4">Facility & Features<h4> 
            <div class="card border-0 shadow-sm mb-4 overflow-hidden"  >
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-3">
                      <h5 class="card-title m-0">Features</h5>
                      <button type="button" class="btn btn-dark shodowe-none btn-sn" data-bs-toggle="modal" data-bs-target="#features-s">
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                        <h5 class="card-title m-0">Facilitys</h5>
                        <button type="button" class="btn btn-dark shodowe-none btn-sn" data-bs-toggle="modal" data-bs-target="#facility-s">
                            <i class="bi bi-plus-square"></i> Add
                        </button>
                </div>
                <div class="table-responsive-md" style="height: 350px; overflow-y:scroll;">
                ...
                <form id="facility_s_form">
                  <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="mb-3">
                            <label class="form-lable fw-bold">Description</label>
...
?>  
<script src="script/features_facilitiy.js"></script>
